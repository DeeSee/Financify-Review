/// ## Ревью: `Financify/Scenes/TransactionsList/LoadingAnimation.swift`
/// 
/// ## Важно
/// - Текст “Загрузка...” захардкожен — лучше локализовать.
/// - Размеры label (`200x200`) фиксированы. На маленьких экранах/в split view это может выглядеть странно.
/// 
/// ## Нюансы
/// - Анимация крутится `repeatForever` и не имеет явного сброса в `onDisappear`. Обычно SwiftUI сам разруливает, но при сложных переходах может быть полезно контролировать.
/// 
